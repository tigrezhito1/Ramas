    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 221461))),
            ],
            options={
                'verbose_name': 'Agente',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 214240))),
            ],
        ),
        migrations.CreateModel(
            name='Base',
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 209047))),
            ],
        ),
        migrations.CreateModel(
            name='Campania',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateTimeField(db_column='fecha cargada', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 194917))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 189745))),
            ],
        ),
        migrations.CreateModel(
            name='DBlaster',
            fields=[
                ...
                ('campania', models.ForeignKey(blank=True, db_column='evento', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Campania')),
                ('cliente', models.ForeignKey(blank=True, db_column='cliente', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Cliente')),
            ],
            options={
                'db_table': 'd_blaster',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_d_blaster', models.ForeignKey(blank=True, db_column='id_d_blaster', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.DBlaster')),
            ],
            options={
                'db_table': 'd_llamadas',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(blank=True, max_length=100)),
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 193526))),
            ],
        ),
        migrations.CreateModel(
            name='Estadocampania',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(blank=True, max_length=100)),
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 11, 5, 20, 1, 57, 184902))),
        ...
        migrations.AddField(
            model_name='agente',
            name='supervisor',
            field=models.ForeignKey(blank=True, db_column='supervisor', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Supervisor'),
        ),
        migrations.AddField(
            model_name='agente',
            name='user',
