...
class Supervisor(models.Model):
    user = models.ForeignKey(User, db_column='user', blank=True, null=True,related_name='callcenteruser')
...
class Agente(models.Model):
    ...
    user = models.ForeignKey(User, db_column='user', blank=True, null=True,related_name='callcenteruseragente')
    supervisor = models.ForeignKey(Supervisor, db_column='supervisor', blank=True, null=True)
    fecha = models.DateTimeField(db_column='fecha', default=datetime.datetime.today())
