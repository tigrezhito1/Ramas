...
const AgregaProveedorCarteraNegocio = ({proveedores,carteras,negocios,selectcartera,guarda}) =>{
                    ...
                    <form onSubmit={guarda}>
                            ...
                            <div class='row'>
                             ...
                             <div style={divStyle}></div>
                                    ...
                                    <button type="submit" class="btn btn-primary" onClick={(e)=>guarda(e)} >Guardar</button>
...
export default connect(mapStateToProps)(AgregaProveedorCarteraNegocio);